...
$usuario = null;
// --- LÓGICA DO UPDATE (U) ---
// Verifica se o formulário de "Update" foi enviado
...
// Se não encontrou o usuário, volta ao index
if (!$usuario) {
 header("Location: index.php");
 exit;
}
...
<body>
 ...
 <br><br>
 <label>Nome:</label>
 <input type="text" name="update_nome" value="<?=
htmlspecialchars($usuario['nome_completo']) ?>" required>
 <br><br>
 <label>Email:</label>
