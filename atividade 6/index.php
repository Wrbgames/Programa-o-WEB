...
$mensagem = "";
// --- LÓGICA DO CREATE (C) ---
// Verifica se o formulário de "Criar" foi enviado
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['criar_nome'])) {

    // (Vamos pular o hash da senha por enquanto para focar no CRUD)
 ...
 <tbody>
     <?php foreach ($usuarios as $user): ?>
      <tr>
         ...
         <a href="excluir.php?id=<?= $user['id'] ?>" onclick="return confirm('Tem
      certeza?')">Excluir</a>
     </td>
    </tr>
   <?php endforeach; ?>
